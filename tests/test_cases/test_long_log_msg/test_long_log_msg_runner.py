...
def test_test_long_log_msg_runner():
    """Test test_long_log_msg using the Python runner."""
    ...
    if toplevel_lang == "verilog":
        sources = [test_dir / "test_cases/test_long_log_msg/test.sv"]
    else:
        sources = [test_dir / "test_cases/test_long_log_msg/test.vhd"]
    ...
    runner.test(
        hdl_toplevel="test",
        hdl_toplevel_lang=toplevel_lang,
        test_module="test_long_log_msg",
        test_args=test_args,
    )


if __name__ == "__main__":
    test_test_long_log_msg_runner()
