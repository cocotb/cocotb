...
def test_issue_2255_runner():
    """Test issue_2255 using the Python runner."""
    ...
    if toplevel_lang == "verilog":
        sources = [test_dir / "test_cases/issue_2255/test.sv"]
    else:
        sources = [test_dir / "test_cases/issue_2255/test.vhd"]
    ...
    runner.test(
        hdl_toplevel="test",
        hdl_toplevel_lang=toplevel_lang,
        test_module="issue_2255",
        test_args=test_args,
    )


if __name__ == "__main__":
    test_issue_2255_runner()
