...
def test_test_first_on_coincident_triggers_runner():
    """Test test_first_on_coincident_triggers using the Python runner."""
    ...
    if toplevel_lang == "verilog":
        sources = [test_dir / "test_cases/test_first_on_coincident_triggers/test.sv"]
    else:
        sources = [test_dir / "test_cases/test_first_on_coincident_triggers/test.vhd"]
    ...
    runner.test(
        hdl_toplevel="test",
        hdl_toplevel_lang=toplevel_lang,
        test_module="test_first_on_coincident_triggers",
        test_args=test_args,
    )


if __name__ == "__main__":
    test_test_first_on_coincident_triggers_runner()
