...
def test_test_defaultless_parameter_runner():
    """Test test_defaultless_parameter using the Python runner."""
    ...
    if toplevel_lang == "verilog":
        sources = [
            test_dir
            / "test_cases/test_defaultless_parameter/test_defaultless_parameter.sv"
        ]
    else:
    ...
    runner.build(
        sources=sources,
        hdl_toplevel="cocotb_defaultless_parameter",
    ...
    runner.test(
        hdl_toplevel="cocotb_defaultless_parameter",
        hdl_toplevel_lang=toplevel_lang,
        test_module="test_defaultless_parameter",
        test_args=test_args,
    )


if __name__ == "__main__":
    test_test_defaultless_parameter_runner()
