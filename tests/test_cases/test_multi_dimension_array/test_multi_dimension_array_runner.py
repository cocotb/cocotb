...
def test_test_multi_dimension_array_runner():
    """Test test_multi_dimension_array using the Python runner."""
    ...
    if toplevel_lang == "verilog":
        sources = [
            test_dir / "designs/multi_dimension_array/cocotb_array_pkg.sv",
            test_dir / "designs/multi_dimension_array/cocotb_array.sv",
        ]
    else:
    ...
    runner.test(
        hdl_toplevel="cocotb_array",
        hdl_toplevel_lang=toplevel_lang,
        test_module="test_cocotb_array",
        test_args=test_args,
    )


if __name__ == "__main__":
    test_test_multi_dimension_array_runner()
