...
def test_in_2d_vect_packed_packed(dut):
    yield Timer(10)
    print(
        "Setting: dut.in_2d_vect_packed_packed type %s"
        % type(dut.in_2d_vect_packed_packed)
    )
    dut.in_2d_vect_packed_packed = (0x5 << 6) | (0x5 << 3) | 0x5
    yield Timer(10)
    print(
        "Getting: dut.out_2d_vect_packed_packed type %s"
        % type(dut.out_2d_vect_packed_packed)
    )
...
def test_in_2d_vect_packed_unpacked(dut):
    yield Timer(10)
    print(
        "Setting: dut.in_2d_vect_packed_unpacked type %s"
        % type(dut.in_2d_vect_packed_unpacked)
    )
    dut.in_2d_vect_packed_unpacked = [0x5, 0x5, 0x5]
    yield Timer(10)
    print(
        "Getting: dut.out_2d_vect_packed_unpacked type %s"
        % type(dut.out_2d_vect_packed_unpacked)
    )
...
def test_in_2d_vect_unpacked_unpacked(dut):
    yield Timer(10)
    print(
        "Setting: dut.in_2d_vect_unpacked_unpacked type %s"
        % type(dut.in_2d_vect_unpacked_unpacked)
    )
    dut.in_2d_vect_unpacked_unpacked = 3 * [[0x1, 0x0, 0x1]]
    yield Timer(10)
    print(
        "Getting: dut.out_2d_vect_unpacked_unpacked type %s"
        % type(dut.out_2d_vect_unpacked_unpacked)
    )
...
def test_in_vect_packed_packed_packed(dut):
    yield Timer(10)
    print(
        "Setting: dut.in_vect_packed_packed_packed type %s"
        % type(dut.in_vect_packed_packed_packed)
    )
    dut.in_vect_packed_packed_packed = 95869805
    yield Timer(10)
    print(
        "Getting: dut.out_vect_packed_packed_packed type %s"
        % type(dut.out_vect_packed_packed_packed)
    )
...
def test_in_vect_packed_packed_unpacked(dut):
    yield Timer(10)
    print(
        "Setting: dut.in_vect_packed_packed_unpacked type %s"
        % type(dut.in_vect_packed_packed_unpacked)
    )
    dut.in_vect_packed_packed_unpacked = [95869805, 95869805, 95869805]
    yield Timer(10)
    print(
        "Getting: dut.out_vect_packed_packed_unpacked type %s"
        % type(dut.out_vect_packed_packed_unpacked)
    )
...
def test_in_vect_packed_unpacked_unpacked(dut):
    yield Timer(10)
    print(
        "Setting: dut.in_vect_packed_unpacked_unpacked type %s"
        % type(dut.in_vect_packed_unpacked_unpacked)
    )
    dut.in_vect_packed_unpacked_unpacked = 3 * [3 * [5]]
    yield Timer(10)
    print(
        "Getting: dut.out_vect_packed_unpacked_unpacked type %s"
        % type(dut.out_vect_packed_unpacked_unpacked)
    )
...
def test_in_vect_unpacked_unpacked_unpacked(dut):
    yield Timer(10)
    print(
        "Setting: dut.in_vect_unpacked_unpacked_unpacked type %s"
        % type(dut.in_vect_unpacked_unpacked_unpacked)
    )
    dut.in_vect_unpacked_unpacked_unpacked = 3 * [3 * [[1, 0, 1]]]
    yield Timer(10)
    print(
        "Getting: dut.out_vect_unpacked_unpacked_unpacked type %s"
        % type(dut.out_vect_unpacked_unpacked_unpacked)
    )
...
def test_in_arr_packed_packed(dut):
    ...
    yield Timer(10)
    print(
        "Getting: dut.out_arr_packed_packed type %s" % type(dut.out_arr_packed_packed)
    )
...
def test_in_arr_packed_unpacked(dut):
    yield Timer(10)
    print(
        "Setting: dut.in_arr_packed_unpacked type %s" % type(dut.in_arr_packed_unpacked)
    )
    dut.in_arr_packed_unpacked = [365, 365, 365]
    yield Timer(10)
    print(
        "Getting: dut.out_arr_packed_unpacked type %s"
        % type(dut.out_arr_packed_unpacked)
    )
...
def test_in_arr_unpacked_unpacked(dut):
    yield Timer(10)
    print(
        "Setting: dut.in_arr_unpacked_unpacked type %s"
        % type(dut.in_arr_unpacked_unpacked)
    )
    dut.in_arr_unpacked_unpacked = 3 * [3 * [5]]
    yield Timer(10)
    print(
        "Getting: dut.out_arr_unpacked_unpacked type %s"
        % type(dut.out_arr_unpacked_unpacked)
    )
