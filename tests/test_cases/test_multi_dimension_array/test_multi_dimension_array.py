...
@cocotb.xfail(
    questa_vpi_compat,
    raises=IndexError,
    reason="Questa (VPI/compat mode) is unable to access elements of a logic array if the last dimension is unpacked (gh-2605)",
)
@cocotb.test
...
@cocotb.skipif(
    ...
    reason="Riviera fails when trying to access packed structs (gh-4753)",
)
@cocotb.test
