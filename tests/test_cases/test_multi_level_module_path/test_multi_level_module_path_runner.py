...
def test_test_multi_level_module_path_runner():
    """Test test_multi_level_module_path using the Python runner."""
    ...
    runner.test(
        hdl_toplevel="sample_module",
        hdl_toplevel_lang=toplevel_lang,
        test_module="test_package.test_module_path",
        test_args=test_args,
    )


if __name__ == "__main__":
    test_test_multi_level_module_path_runner()
