...
def test_test_packed_union_runner():
    """Test test_packed_union using the Python runner."""
    ...
    if toplevel_lang == "verilog":
        sources = [test_dir / "test_cases/test_packed_union/test_packed_union.sv"]
    else:
    ...
    runner.build(
        sources=sources,
        hdl_toplevel="test_packed_union",
    ...
    runner.test(
        hdl_toplevel="test_packed_union",
        hdl_toplevel_lang=toplevel_lang,
        test_module="test_packed_union",
        test_args=test_args,
    )


if __name__ == "__main__":
    test_test_packed_union_runner()
