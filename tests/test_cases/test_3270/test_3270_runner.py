...
def test_test_3270_runner():
    """Test test_3270 using the Python runner."""
    ...
    if toplevel_lang == "verilog":
        sources = [test_dir / "test_cases/test_3270/test_3270.sv"]
    else:
    ...
    runner.test(
        hdl_toplevel="trigger_counter",
        hdl_toplevel_lang=toplevel_lang,
        test_module="test_3270",
        test_args=test_args,
    )


if __name__ == "__main__":
    test_test_3270_runner()
