...
def test_test_fatal_runner():
    """Test test_fatal using the Python runner."""
    ...
    if toplevel_lang == "verilog":
        sources = [test_dir / "test_cases/test_fatal/fatal.sv"]
    else:
        sources = [test_dir / "test_cases/test_fatal/fatal.vhd"]
    ...
    runner.test(
        hdl_toplevel="fatal",
        hdl_toplevel_lang=toplevel_lang,
        test_module="test_fatal",
        test_args=test_args,
    )


if __name__ == "__main__":
    test_test_fatal_runner()
