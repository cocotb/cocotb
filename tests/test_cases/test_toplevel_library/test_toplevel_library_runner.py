...
def test_test_toplevel_library_runner():
    """Test test_toplevel_library using the Python runner."""
    ...
    if toplevel_lang == "verilog":
        ...
        sources = [test_dir / "test_cases/test_toplevel_library/mylib.vhd"]
    ...
    runner.test(
        hdl_toplevel="myentity",
        hdl_toplevel_lang=toplevel_lang,
        test_module="test_myentity",
        test_args=test_args,
    )


if __name__ == "__main__":
    test_test_toplevel_library_runner()
