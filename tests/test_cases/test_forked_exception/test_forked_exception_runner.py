...
def test_test_forked_exception_runner():
    """Test test_forked_exception using the Python runner."""
    ...
    runner.test(
        hdl_toplevel="sample_module",
        hdl_toplevel_lang=toplevel_lang,
        test_module="test_forked_exception",
        test_args=test_args,
    )


if __name__ == "__main__":
    test_test_forked_exception_runner()
