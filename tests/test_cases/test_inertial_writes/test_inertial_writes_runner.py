...
def test_test_inertial_writes_runner():
    """Test test_inertial_writes using the Python runner."""
    ...
    runner.test(
        hdl_toplevel="sample_module",
        hdl_toplevel_lang=toplevel_lang,
        test_module="inertial_writes_tests",
        test_args=test_args,
    )


if __name__ == "__main__":
    test_test_inertial_writes_runner()
