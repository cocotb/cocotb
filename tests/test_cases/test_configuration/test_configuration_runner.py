...
def test_test_configuration_runner():
    """Test test_configuration using the Python runner."""
    ...
    if toplevel_lang == "verilog":
        sources = [test_dir / "designs/vhdl_configurations/testbench.sv"]
    else:
        sources = [test_dir / "designs/vhdl_configurations/configurations.vhd"]
    ...
    runner.test(
        hdl_toplevel="testbench",
        hdl_toplevel_lang=toplevel_lang,
        test_module="test_configurations",
        test_args=test_args,
    )


if __name__ == "__main__":
    test_test_configuration_runner()
