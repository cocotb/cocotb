...
def test_test_vhdl_access_runner():
    """Test test_vhdl_access using the Python runner."""
    ...
    runner.test(
        hdl_toplevel="dec_viterbi_ent",
        hdl_toplevel_lang=toplevel_lang,
        test_module="test_vhdl_access",
        test_args=test_args,
    )


if __name__ == "__main__":
    test_test_vhdl_access_runner()
