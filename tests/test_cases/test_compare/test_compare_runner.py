...
def test_test_compare_runner():
    """Test test_compare using the Python runner."""
    ...
    if toplevel_lang == "verilog":
        sources = [test_dir / "designs/basic_hierarchy_module/basic_hierarchy_module.v"]
    else:
