...
def test_test_module_without_tests_runner():
    """Test test_module_without_tests using the Python runner."""
    ...
    runner.test(
        hdl_toplevel="sample_module",
        hdl_toplevel_lang=toplevel_lang,
        test_module="test_nothing",
        test_args=test_args,
    )


if __name__ == "__main__":
    test_test_module_without_tests_runner()
