...
This test is based on the test 'test_avalon_stream', but uses nonstandard names
for the streaming interfaces."""
...
class AvalonSTTB(object):
    ...
    def __init__(self, dut):
        ...
        self.backpressure = BitDriver(self.dut.aso_RDY, self.dut.clk)
