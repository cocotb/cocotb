...
def test_test_select_testcase_runner():
    """Test test_select_testcase using the Python runner."""
    ...
    runner.test(
        hdl_toplevel="sample_module",
        hdl_toplevel_lang=toplevel_lang,
        test_module="x_tests,y_tests,y_tests_again",
        test_args=test_args,
    )


if __name__ == "__main__":
    test_test_select_testcase_runner()
