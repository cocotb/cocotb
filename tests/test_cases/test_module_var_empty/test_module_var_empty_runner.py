...
def test_test_module_var_empty_runner():
    """Test test_module_var_empty using the Python runner."""
    ...
    runner.test(
        hdl_toplevel="sample_module",
        hdl_toplevel_lang=toplevel_lang,
        test_module="test_module_var_empty",
        test_args=test_args,
    )


if __name__ == "__main__":
    test_test_module_var_empty_runner()
