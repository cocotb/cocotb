...
async def test_default_1(dut) -> None:
    """Test default arguments from @cocotb.test decorator under pytest as regression manager."""
...
async def test_skip_true(dut) -> None:
    """Test skip from @cocotb.test decorator under pytest as regression manager."""
...
async def test_timeout(dut, clock_generation) -> None:
    """Test timeout from @cocotb.test decorator under pytest as regression manager."""
    for _ in range(100):
...
async def test_state_30(dut) -> None:
    """Test stage from @cocotb.test decorator under pytest as regression manager."""
...
async def test_expect_fail_true(dut) -> None:
    """Test expect fail from @cocotb.test decorator under pytest as regression manager."""
...
async def test_expect_error_none(dut) -> None:
    """Test expect error from @cocotb.test decorator under pytest as regression manager."""
...
async def test_xfail_default(dut) -> None:
    """Test @cocotb.xfail decorator under pytest as regression manager."""
    raise RuntimeError("expecting any error")
...
async def test_skipif_true(dut) -> None:
    """Test @cocotb.skipif decorator under pytest as regression manager."""
    raise RuntimeError("skipped error")
...
async def test_parametrize_empty(dut) -> None:
    """Test @cocotb.parametrize decorator under pytest as regression manager."""
