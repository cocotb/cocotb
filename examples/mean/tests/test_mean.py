...
def value_test(dut, num):
    ...
    dut.log.info('Detected DATA_WIDTH = %d, BUS_WIDTH = %d' %(data_width, bus_width))
...
#    dut_in = StreamBusMonitor(dut, "i", dut.clk)  # this doesn't work; VPI Error vpi_get_value(): ERROR - Cannot get a value for an object of type vpiArrayVar. 
