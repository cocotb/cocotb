...
from typing import Any, Callable, Generic, NoReturn, TypeVar, Union, cast
...
_write_task: Task[None] | None = None
...
class ValueObjectBase(SimHandleBase, Generic[ValueGetT, ValueSetT]):
    ...
    @abstractmethod
    def _set_value(self, value: ValueSetT, action: _GPISetAction) -> None:
...
class ArrayObject(
    ...
    def _set_value(
        self, value: Array[ElemValueT] | Sequence[ElemValueT], action: _GPISetAction
    ) -> None:
...
class LogicObject(_NonIndexableValueObjectBase[Logic, Union[Logic, int, str]]):
    ...
    def _set_value(self, value: Logic | int | str, action: _GPISetAction) -> None:
        value_: str
...
class LogicArrayObject(
    ...
    def _set_value(
        self, value: LogicArray | Logic | int | str, action: _GPISetAction
    ) -> None:
        value_: str
...
class RealObject(_NonIndexableValueObjectBase[float, float]):
    ...
    def _set_value(self, value: float, action: _GPISetAction) -> None:
...
class EnumObject(_NonIndexableValueObjectBase[int, int]):
    ...
    def _set_value(self, value: int, action: _GPISetAction) -> None:
    ...
    def set(
        self, value: int | Deposit[int] | Force[int] | Freeze | Release | Immediate[int]
    ) -> None:
...
class StringObject(
    ...
    def _set_value(self, value: bytes, action: _GPISetAction) -> None:
