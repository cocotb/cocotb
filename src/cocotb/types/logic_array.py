...
class LogicArray(ArrayLike[Logic]):
    ...
    def from_unsigned(
        ...
        The :class:`int` is treated as an arbitrarily-length bit vector with unsigned representation where the left-most bit is the most significant bit.
        ...
        """
        if value < 0:
            raise ValueError("Given value isn't unsigned.")
    ...
    def from_signed(
        ...
        The :class:`int` is treated as an arbitrarily-length bit vector with two's complement representation where the left-most bit is the most significant bit.
        This bit vector is then constructed into a :class:`LogicArray`.
