...
class LogicArray(AbstractMutableArray[Logic]):
    ...
    @classmethod
    def from_unsigned(cls, value: int, range: Range | int) -> LogicArray:
    ...
    @classmethod
    def from_signed(cls, value: int, range: Range | int) -> LogicArray:
    ...
    def to_bytes(self, *, byteorder: ByteOrder) -> bytes:
