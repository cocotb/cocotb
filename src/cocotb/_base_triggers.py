...
from cocotb._py_compat import ParamSpec, Self, cached_property, insertion_ordered_dict
...
class Trigger:
    ...
    def _register(
        ...
        handle = TriggerCallback(func, *args, **kwargs)
    ...
    def _prime(self) -> None:
        """Enables the underlying mechanism for the Trigger to fire.
    ...
    def _unprime(self) -> None:
        """Disables the underlying mechanism for the Trigger to fire."""
