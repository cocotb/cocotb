...
class Runner(ABC):
    ...
    def build(
        ...
        self.waves = env.as_bool("WAVES", waves)
    ...
    def test(
        ...
        pytest_current_test: str = env.as_str("PYTEST_CURRENT_TEST")
        ...
        if pytest_current_test and self._use_external_viewer() and self.gui:
            viewer: str = env.as_str("COCOTB_WAVEFORM_VIEWER")
            if viewer:
