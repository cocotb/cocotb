...
#: Pytest as regression manager for cocotb tests
_ENTRY_POINT: str = "cocotb_tools._pytest._init:run_regression"
...
def pytest_configure(config: Config) -> None:
    ...
    if _ENTRY_POINT not in option.pygpi_users:
        option.pygpi_users.append(_ENTRY_POINT)
