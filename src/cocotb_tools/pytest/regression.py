...
class RegressionManager:
    ...
    def __init__(
        ...
        *args: str,
        ...
        """List of test setups populate from the pytest_fixture_setup hook."""

        self._call: RunningTest | None = None
        """Test call populate from the pytest_runtest_call hook."""

        self._teardowns: deque[RunningTest] = deque[RunningTest]()
        """List of test teardowns populate from setup finalizers."""
    ...
    def _call_and_report(
        ...
        **kwargs: object,
        ...
        Args:
            ...
            kwargs: Additional named arguments that will be passed to test function.
