...
latex_documents = [
    ("index", "cocotb.tex", u"cocotb Documentation", u"PotentialVentures", "manual")
]
...
man_pages = [("index", "cocotb", u"cocotb Documentation", [u"PotentialVentures"], 1)]
...
subprocess.call(
    ["breathe-apidoc", "-o", "source/generated", "source/doxygen/_xml", "-f"],
    env=env,
    cwd="..",
)
