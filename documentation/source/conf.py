...
if read_the_docs_build:
    ...
    subprocess.call('cd ..; breathe-apidoc -o source/generated source/doxygen/_xml -f', shell=True)
else:  # local
    subprocess.call('cd ..; doxygen', shell=True)
    subprocess.call('cd ..; .venv/bin/breathe-apidoc -o source/generated source/doxygen/_xml -f', shell=True)
