...
For a more IDE-friendly debugging experience — with full breakpoint support, variable
inspection, and call stack navigation in editors such as VS Code and PyCharm — use
``debugpy``. See :doc:`debugpy` for a complete step-by-step guide.
