...
:external+cocotb1.9:py:func:`cocotb.fork` was removed and replaced with :func:`cocotb.start_soon`.
...
********************************
``@cocotb.coroutine`` Coroutines
********************************

Change
======

Support for generator-based coroutines using the :external+cocotb1.9:py:class:`@cocotb.coroutine <cocotb.coroutine>` decorator
...
and the behavior of ``@cocotb.coroutine`` would have to be changed to support changes to the scheduler.
