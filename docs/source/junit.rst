...
Generated XML file with tests results by cocotb regression manager is compatible with `Jenkins xUnit schema version 2`_.
...
.. code:: xml
    ...
    <system-out>[[ATTACHMENT|sim_build/dff.vcd]]
...
Only subset of XML elements and attributes from `Jenkins xUnit schema version 2`_ are supported.
